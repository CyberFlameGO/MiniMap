...
public class PositionCategory extends Category {
    ...
    public void renderContent(MatrixStack matrixStack, float mouseX, float mouseY, float delta) {
        ...
        Font.GOODDOG.drawCentered(matrixStack, Lang.CATEGORY_POSITION, x + 3F, y + 3F, 0x88000000);
        Font.GOODDOG.drawCentered(matrixStack, Lang.CATEGORY_POSITION, x, y, 0xFFFFFFFF);
    }
}
