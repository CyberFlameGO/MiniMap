    ...
    private class ScanTask extends Task {
        ...
        public void run() {
            ...
            for (MapChunk mapChunk : loadedChunks) {
                ...
                List<Block> invisibleBlocks = new ArrayList<>();
                    ...
                    for (int z = 0; z < 16; z++) {
                        ...
                        // heightmap layer
                        {
                            ...
                            if (z + 1 < 16) {
                                ...
                                pos2.set(Numbers.chunkToBlock(chunkX) + x, y, Numbers.chunkToBlock(chunkZ) + z + 1);
                                do { // todo - clean up all this duplicate code
                            ...
                            if (x + 1 < 16) {
                                ...
                                pos2.set(Numbers.chunkToBlock(chunkX) + x + 1, y, Numbers.chunkToBlock(chunkZ) + z);
                                do {
                                    pos2.move(Direction.DOWN);
                                    state = world.getBlockState(pos2);
                                    color = state.getMapColor(world, pos2).color;
